...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Dokumentasi API DriverService'
}));
...
app.get('/', (req, res) => {
  res.json({
    pesan: 'DriverService API - TransTrack Microservice',
    message: 'API untuk mengelola data master pengemudi',
    version: '1.0.0',
...
// Start server
app.listen(PORT, () => {
  console.log(`DriverService berjalan pada port ${PORT}`);
