...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Dokumentasi API MaintenanceService'
}));
...
app.get('/', (req, res) => {
  res.json({
    pesan: 'MaintenanceService API - TransTrack Microservice',
    message: 'API untuk mengelola data master riwayat dan jadwal perbaikan bus',
    version: '1.0.0',
...
// Start server
app.listen(PORT, () => {
  console.log(`MaintenanceService berjalan pada port ${PORT}`);
